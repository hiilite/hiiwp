...
//
//////////////////////////////
if(!function_exists('hiilite_add_dashboard_widgets')){
...
if(!function_exists('hiilite_add_welcome_widget')){
...
if(!function_exists('hiilite_remove_dashboard_widgets')){
...
if(!function_exists('hiilite_move_dashboard_widget')){
...
//
//////////////////////////////////
if(!function_exists('modify_admin_bar')){
