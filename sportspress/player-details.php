...
if ( $show_number ):
	$common[ 'Jersey Number' ] = $player->number;
endif;
...
$output = '<div class="sp-template sp-template-player-details sp-template-details col-6 grid-right"><div class="sp-list-wrapper"><dl class="sp-player-details">';
