...
class Kirki_Control_Typography extends Kirki_Control_Base {
	...
	protected function l10n() {
		return array(
			'fontFamily'       => esc_attr__( 'Font Family', 'hiiwp' ),
			'selectFontFamily' => esc_attr__( 'Select Font Family', 'hiiwp' ),
			'backupFont'       => esc_attr__( 'Backup Font', 'hiiwp' ),
			'variant'          => esc_attr__( 'Variant', 'hiiwp' ),
			'fontSize'         => esc_attr__( 'Font Size', 'hiiwp' ),
			'lineHeight'       => esc_attr__( 'Line Height', 'hiiwp' ),
			'letterSpacing'    => esc_attr__( 'Letter Spacing', 'hiiwp' ),
			'wordSpacing'      => esc_attr__( 'Word Spacing', 'hiiwp' ),
			'textAlign'        => esc_attr__( 'Text Align', 'hiiwp' ),
			'inherit'          => esc_attr__( 'Inherit', 'hiiwp' ),
			'left'             => esc_attr__( 'Left', 'hiiwp' ),
			'center'           => esc_attr__( 'Center', 'hiiwp' ),
			'justify'          => esc_attr__( 'Justify', 'hiiwp' ),
			'textTransform'    => esc_attr__( 'Text Transform', 'hiiwp' ),
			'none'             => esc_attr__( 'None', 'hiiwp' ),
			'capitalize'       => esc_attr__( 'Capitalize', 'hiiwp' ),
			'uppercase'        => esc_attr__( 'Uppercase', 'hiiwp' ),
			'lowercase'        => esc_attr__( 'Lowercase', 'hiiwp' ),
			'initial'          => esc_attr__( 'Initial', 'hiiwp' ),
			'inherit'          => esc_attr__( 'Inherit', 'hiiwp' ),
			'color'            => esc_attr__( 'Color', 'hiiwp' ),
			'marginTop'        => esc_attr__( 'Margin Top', 'hiiwp' ),
			'marginBottom'     => esc_attr__( 'Margin Bottom', 'hiiwp' ),
		);
	}
}
