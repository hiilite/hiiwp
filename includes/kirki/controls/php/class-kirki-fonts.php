...
final class Kirki_Fonts {
	...
	public static function get_google_fonts() {
		...
		if ( null === self::$google_fonts || empty( self::$google_fonts ) ) {
			...
			$fonts = include_once dirname( __FILE__ ) . '/webfonts.php';
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'hiiwp' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'hiiwp' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'hiiwp' ),
			'200'       => esc_attr__( 'Light 200', 'hiiwp' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'hiiwp' ),
			'300'       => esc_attr__( 'Book 300', 'hiiwp' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'hiiwp' ),
			'400'       => esc_attr__( 'Normal 400', 'hiiwp' ),
			'regular'   => esc_attr__( 'Normal 400', 'hiiwp' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'hiiwp' ),
			'500'       => esc_attr__( 'Medium 500', 'hiiwp' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'hiiwp' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'hiiwp' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'hiiwp' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'hiiwp' ),
			'700'       => esc_attr__( 'Bold 700', 'hiiwp' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'hiiwp' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'hiiwp' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'hiiwp' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'hiiwp' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'hiiwp' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'hiiwp' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'hiiwp' ),
		);
	}
