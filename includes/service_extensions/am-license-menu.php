...
if ( ! class_exists( 'AM_License_Menu' ) ) {
	class AM_License_Menu {
		...
		// Returns the API Key instance id from the WooCommerce API Manager on the server
		public function wc_am_api_key_instance() {
			// TODO
			//echo $this->ame_instance_key;
			echo $this->ame_instance_id;
			echo $this->ame_product_id;
		}
