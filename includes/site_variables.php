<?php
/**
 * HiiWP: Site Variables
 *
 * A collection of all the default settings in the theme.
 *
 * @package     hiiwp
...
$hiilite_options['social_icon_settings_bg']				= get_theme_mod( 'social_icon_settings_bg', array(
        'background'    => 'rgba(255,255,255,0)',
    ));
$hiilite_options['social_icon_settings_border_r']				= get_theme_mod( 'social_icon_settings_border_r', '2em');
$hiilite_options['typography_social_icon_custom_css']	= get_theme_mod( 'typography_social_icon_custom_css', '.social-profiles a .fa, 
.social-profiles .fa {
	display: inline-block;
	width: 1.6em;
	text-align: center;
...
$hiilite_options['blog_single_text_font']    = get_theme_mod('blog_single_text_font', array(
        'font-family'    => ' ',
        'variant'        => ' ',
        'font-size'      => '16px',
        'line-height'    => ' ',
...
12.0 Portfolio
--------------------------------------------------------------*/
$hiilite_options['portfolio_layout']		= get_theme_mod( 'portfolio_layout', 'split' );
...
$hiilite_options['portfolio_show_post_meta']= get_theme_mod( 'portfolio_show_post_meta', true );
...
$hiilite_options['portfolio_add_padding']	= get_theme_mod( 'portfolio_add_padding', '10px' );
